...
class GoalModel(Base):
    ...
    indicators = relationship("IndicatorModel", back_populates="goal", cascade="all, delete-orphan") # Added cascade
    __table_args__ = (
...
def list_objectives(
    ...
    """
    List objectives, calculating and joining the average progress
    percentage from their child indicators.
    """
    ...
    # Subquery: Average progress per objective_id
    ...
    # Outer join objectives with their average progress
    q = q.outerjoin(
        avg_progress_subquery,
    ...
    # Select the Objective model and the calculated average
    q = q.with_entities(
        ObjectiveModel,
